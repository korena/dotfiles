...
" nnoremap <silent> <leader>sf :<C-U>Leaderf file --popup<CR>
" Search files using Telescope
nnoremap <silent> <leader>sf <cmd>Telescope find_files<CR>
" Search the file under the cursor using Telescope, not great for includes of
" dtsi
nnoremap <expr> <leader>sF ':Telescope find_files<cr>' . "'" . expand('<cword>')

" Grep project files in popup window
" nnoremap <silent> <leader>sg :<C-U>Leaderf rg --no-messages --popup<CR>
" Grep project files using Telescope
nnoremap <silent> <leader>sg <cmd>Telescope live_grep<CR>

" grep project for string under cursor
nnoremap <silent> <leader>sd <cmd>Telescope grep_string<CR>

" Search vim help files
" nnoremap <silent> <leader>sh :<C-U>Leaderf help --popup<CR>
" Search vim help files using Telescope
...
" Switch buffers
" nnoremap <silent> <leader>sb :<C-U>Leaderf buffer --popup<CR>
" Switch buffers using Telescope
nnoremap <silent> <leader>sb <cmd>Telescope buffers<CR>

" Search recent files
nnoremap <silent> <leader>sr :<C-U>Leaderf mru --popup<CR>
